...
// Preceptor (Primaria, "cargo"), y Profesor (Secundaria, "hora_catedra").
...
// los cargos de Primaria (438/455/2575 son fijos sin importar la
// modalidad; 641 escala con las unidades reales SOLO para Maestro de
// Grado — ver multiplicador641()). Para hora_catedra (Profesor), los
// montos fijos SÍ escalan — pero con la cantidad de horas, no con
// "unidades" — ver cantidadModulos en DocDesignacion.
//
...
//   - Preceptor en Secundaria (concepto 653 en vez de 641) — solo
//     tenemos UN caso real, no alcanza para confirmar cómo escala. Sigue
//     sin cargar hasta tener un segundo caso de comparación.
 ...
 */
export function liquidarDesignacion({ cargo, valorPorIndice, aniosAntiguedad, tramosAntiguedad, conceptos, zonaRural = false, cantidadModulos = 1 }) {
  const basico =
