...
//
// ALCANCE DE FASE 1 (documentado, no un olvido):
//   - GARANTÍA (códigos 2761 "MAR/2007" y 648 "730") NO está
//     implementada — y no por limitación nuestra, sino porque el
//     mecanismo real dejó de tener efecto en agosto de 2015: "GARANTÍA:
//     lo cobraban los docentes que recién se iniciaban... tuvo dos
//     etapas de pago (2003-2008 y desde marzo 2015)... y en Agosto de
//     2015 esta suma deja de cobrarse porque se absorbió al sueldo con
//     dicho aumento" (SUTEBA Alte. Brown, "Conceptos de nuestro salario
//     docente", actualizado agosto 2026). El piso que garantizaba ya
//     está adentro de los básicos actuales — lo que aparece hoy en los
//     recibos (unos pocos cientos de pesos, cuando aparece) es un
//     resabio de cálculo de un mecanismo legal inactivo, no una pieza
//     que falte. Confirmado además cruzando 5 casos reales: implicaba
//     "pisos" distintos e inconsistentes entre sí — no una fórmula viva.
